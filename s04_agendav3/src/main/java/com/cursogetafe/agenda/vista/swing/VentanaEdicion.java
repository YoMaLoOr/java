...
public class VentanaEdicion extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaEdicion(Agenda agenda, Contacto contactoActual, int modo, VInicial padre) {
		setTitle("Contactos");
...
//		this.contactoActual = contactoActual;
		...
		btnAgregarTelefono.setIcon(new ImageIcon(VentanaEdicion.class.getResource("/images/icono_ok.png")));
		...
		btnAgregarCorreo.setIcon(new ImageIcon(VentanaEdicion.class.getResource("/images/icono_ok.png")));
		...
		btnBorrarTelefono.setIcon(new ImageIcon(VentanaEdicion.class.getResource("/images/cancel-remove-icone-5993-96.png")));
		...
		btnBorrarCorreo.setIcon(new ImageIcon(VentanaEdicion.class.getResource("/images/cancel-remove-icone-5993-96.png")));
