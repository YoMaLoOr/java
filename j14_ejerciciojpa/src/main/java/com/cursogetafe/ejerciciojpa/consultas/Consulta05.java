...
public class Consulta05 {
    public static void main(String[] args) {
        ...
        //Busca todos los clientes con todos los datos que estan por defecto en modo eager
        //No carga los productos (lazy)
        //Para cargar los datos realiza una consulta por cada idRol
        ...
        TypedQuery<Cliente> q = em.createQuery(jpql1, Cliente.class);
        ...
        q = em.createQuery(jpql2, Cliente.class);

        q.getResultList().forEach(System.out::println);

        q = em.createQuery(jpql3, Cliente.class);
